	...
	pushNotifications: {
		...
		labels: {
			...
			personalNotificationMessageBody: {
				title: "Body"
				, placeholder: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} sent you a private message."
				, maxLength: 150
				, defaultValue: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} sent you a private message."
			},
			...
			publicNotificationMessageBody: {
				title: "Body"
				, placeholder: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} added a new post on ${context.plugin.title}"
				, maxLength: 150
				, defaultValue: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} added a new post on ${context.plugin.title}"
			},
			...
			commentNotificationMessageBody: {
				title: "Body"
				, placeholder: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} commented on a post on ${context.plugin.title}"
				, maxLength: 150
				, defaultValue: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} commented on a post on ${context.plugin.title}"
			},
			...
			postLikeNotificationMessageBody: {
				title: "Body"
				, placeholder: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} liked your post."
				, maxLength: 150
				, defaultValue: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} liked your post."
			},
			...
			commentLikeNotificationMessageBody: {
				title: "Body"
				, placeholder: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} liked your comment."
				, maxLength: 150
				, defaultValue: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} liked your comment."
			},
			...
			commentReplyNotificationMessageBody: {
				title: "Body"
				, placeholder: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} replied to your comment."
				, maxLength: 150
				, defaultValue: "${(context.appUser && context.appUser.displayName)?context.appUser.displayName:'Someone'} replied to your comment."
			},
